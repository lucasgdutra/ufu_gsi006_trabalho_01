...
/*inicializa estrutura pilha com valores iniciais, retorna 0 se não houver
 * erro*/
...
/*remove elemento do topo pilha e retorna valor removido pra ponteiro valor do
 * argumento, retorna 0 se não houver erro*/
int desempilha(Pilha *p, void *valor);

/*remove todos elementos da pilha, retorna 0 se não houver erro*/
int limpa_pilha(Pilha *p);

/*copia tamanho da pilha para variavel tam em argumento, retorna 0 se não houver
 * erro*/
